--L1
drop external table hawq_gpfdist4_1000w_ext1;
create external table hawq_gpfdist4_1000w_ext1
...
drop external table hawq_gpfdist4_1000w_ext2;
create external table hawq_gpfdist4_1000w_ext2
 (pk bigint,ff1 double precision,ff2 double precision,sf1 text,if1 int,if2 int,if3 int,if4 int,if5 int,if6 int)
...
drop external table hawq_gpfdist4_1000w_ext3;
create external table hawq_gpfdist4_1000w_ext3
 (pk bigint,ff1 double precision,ff2 double precision,sf1 text,if1 int,if2 int,if3 int,if4 int,if5 int,if6 int)
...
drop external table hawq_gpfdist4_1000w_ext4;
create external table hawq_gpfdist4_1000w_ext4
 (pk bigint,ff1 double precision,ff2 double precision,sf1 text,if1 int,if2 int,if3 int,if4 int,if5 int,if6 int)
